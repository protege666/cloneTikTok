  ...
  test("POST /comments", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        commentTimestamp: CREATE_RESULT.commentTimestamp.toISOString(),
      });
  });
      ...
      .expect([
        {
          ...
          commentTimestamp: FIND_MANY_RESULT[0].commentTimestamp.toISOString(),
        },
      ]);
  });
  ...
  test("GET /comments/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        commentTimestamp: FIND_ONE_RESULT.commentTimestamp.toISOString(),
      });
  });
