  ...
  test("POST /likes", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        likeTimestamp: CREATE_RESULT.likeTimestamp.toISOString(),
      });
  });
      ...
      .expect([
        {
          ...
          likeTimestamp: FIND_MANY_RESULT[0].likeTimestamp.toISOString(),
        },
      ]);
  });
  ...
  test("GET /likes/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        likeTimestamp: FIND_ONE_RESULT.likeTimestamp.toISOString(),
      });
  });
